...
const Navbar = () => {
    return (
        <div className=' fixed z-[999] w-full h-screen px-20 py-8 font-["Neue_Montreal"] flex justify-between '>
            {/* z index 999 so navbar always stays on top and fixed */}
            <div className="logo">
            ...
            <div className="links flex gap-10">
                {/* Loop through the list of links using .map() */}
                {["Services", "Journal", "AboutUS", "Contact", "More"].map((item, index) => (
                    <a
                        // Add a unique key for each link
                        key={index}
                        // The link goes nowhere for now (empty href)
                        href=""
                        // Add common styles and extra margin for the last item
