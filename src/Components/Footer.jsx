...
function Footer() {
	return (
		<div className=" border-t-[1px] border-zinc-600 mt-40 w-full bg-zinc-900  -[#f1f1f1] p-20 flex gap-5  rounded-xl">
			...
			<div className="w-1/2 ">
				...
				<div className="flex pt-[5vw] justify-between font-normal font-['Bebas Neue']">
					<div className="w-1/2">
						...
						<p className=" mt-[2vw] hover:text-black tracking-tight text-lg">
